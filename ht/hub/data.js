...
HT.spaceArtwork = {
  ...
  events: { image: '/ht/img/r-student-center.jpg', alt: 'Rendering of the Huston-Tillotson student center, where campus events gather' },
  ...
  showcase: { image: '/ht/img/r-arena-entry.jpg', alt: 'Rendering of a new Huston-Tillotson campus building entrance' },
...
HT.home = {
  ...
  blocks: [
    { type: 'intro', kicker: 'Huston-Tillotson × Taylormade Academy', title: 'One campus. One hub. Every office.',
      ...
      ada: { text: 'Welcome to the Hill. Three things are coming up: the President\'s Fall Briefing for donors on October 8, the fall town hall on October 15 at noon, and the Charter Day Observance on October 23. Pick a space below and I\'ll walk you in.', when: 'Ada, the Hub’s AI guide · sample' } },
    ...
    { type: 'calendar', side: true, title: 'Coming up on the Hill', meta: 'Sample', items: [
      ...
      { date: '2026-10-23', title: 'Charter Day Observance', where: 'HT\'s published calendar · Campus' },
...
HT.spaces.advancement = {
  ...
  blocks: [
    ...
    { type: 'cards', id: 'pages', title: 'Donor pages', meta: 'Each opens from a text or an email', items: [
      ...
      { meta: 'The ask · before the gift', title: 'Yvette Reed \'92', text: 'Meet Me Halfway, for one person: the promise, the why, three sophomores, and the President before the ask.', tile: { icon: 'gift', label: 'The ask' }, href: 'https://taylormadecreative.github.io/ht-advancement/solicitation.html?to=Yvette%20Reed', badge: 'Sample', foot: 'Open the page →' },
      { meta: 'The update · the endowment', title: 'An endowed fund', text: 'The annual update a fund\'s donors asked for, as a page instead of a letter: the fund, the year, and the names it made possible.', href: 'https://taylormadecreative.github.io/ht-advancement/stewardship.html?to=The%20Founders&fund=Founders%20Endowed%20Scholarship', tile: { icon: 'star', label: 'Endowed fund' }, badge: 'Sample', foot: 'Open the page →' } ] },
