...
HT.home = {
  ...
  blocks: [
    { type: 'intro', kicker: 'Huston-Tillotson × Taylormade Academy', title: 'One campus. One hub. Every office.',
      ...
      ada: { text: 'Welcome to the Hill. Three things are coming up: Orientation Week check-in on Tuesday, the fall town hall Thursday at noon, and the first AI Literacy session on the 14th. Pick a space below and I\'ll walk you in.', when: 'Ada · HT student ambassador · sample line' } },
    { type: 'announcements', title: 'Campus announcements', meta: 'Sample', items: [
      { who: 'Office of the President', when: 'Today', text: 'The fall town hall streams live in the hub Thursday, Sep 10, at noon. The replay lands the same afternoon.' },
...
HT.spaces.advancement = {
  ...
  blocks: [
    ...
    { type: 'announcements', side: true, title: 'Advancement desk', meta: 'Sample', items: [
      ...
      { who: 'Gift officers', when: 'Monday', text: 'Visit folders now print from each donor page, ready for the visit.' } ] },
