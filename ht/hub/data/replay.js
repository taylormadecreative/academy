...
HT.spaces.replay = {
  key: 'replay', tab: 'live', title: 'Session recording', office: 'HT classrooms', icon: 'play',
  ...
  stamp: 'Recording, materials & notes', headCta: { label: 'Back to classrooms', href: '/ht/hub/live/', style: 'ht-line' },
