...
function steps(page, role, ctx) {
  ...
  const facilitator = [
    ...
    { at: ['a.pillbtn[href^="/opil/hub/live/?s="]'], title: 'The class room', body: 'Open room is this session\u2019s own class room. Start the class there with your own camera, nothing to install; students join with the link you copy from the room, can turn their cameras on, share a screen, and chat beside the video.' },
    { at: ['.replayLine', 'a.pillbtn[href^="/opil/hub/live/?s="]'], title: 'Replays', body: 'Your class records itself. The replay lands here as a draft \u2014 review it, then Publish to students so it shows under the session on their hub home.' },
