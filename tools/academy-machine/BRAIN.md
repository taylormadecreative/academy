...
- **Graphics:** clean backgrounds with a FEW small 4-point gold+blue sparkle stars (used sparingly), rounded pills/cards, soft shadows, lots of negative space. **No big blue blob behind the subject** (Nelson rejected it).
...
- Person recipes (`hero-post`, `lifestyle`, `behind-the-build`) **auto-lock his face** from the refs and are **ALWAYS forced to ChatGPT** (never Nano Banana — it garbles his face/text). This is a hard rule; `--engine` can't override it for person posts.
...
7. **Text must be spelled perfectly.** If a render has a typo or mangled letters, regenerate — don't ship it.
